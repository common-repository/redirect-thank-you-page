								...
								<div class="cop_ft_class cop_ft_main_field">
									...
									<div class="forminp">
										<div class="forminp1">
											...
											<label class="wmprty_addon_status_id_label" for="wmprty_addon_status_id"><?php esc_html_e( 'Enable payment gateway redirect custom thank you page', 'redirect-thank-you-page' ); ?></label>
										</div>
									</div>
								</div>
								<div class="cop_ft_class cop_ft_main_field">
									...
									<div class="forminp">
										<div class="forminp1">
											<input type="text" name="wmprty_data[wmprty_addon_name]" id="wmprty_addon_id" placeholder="<?php esc_html_e( 'Enter name of payment gateway redirect thank you page', 'redirect-thank-you-page' ); ?>" value="<?php echo esc_attr( $check_wmprty_addon_name ); ?>">
										</div>
									</div>
								</div>
								<?php
								do_action( 'wmprty_payments_fields', $get_data );
								do_action( 'wmprty_payment_pages_fields', $get_data );
								?>
							</div>
						</div>
